...
namespace MedMIS {
    ...
    public class FirstReport : ReportClass {
    ...
    public class CachedFirstReport : Component, ICachedReport {
        
        public CachedFirstReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FirstReport rpt = new FirstReport();
            rpt.Site = this.Site;
            return rpt;
        }
